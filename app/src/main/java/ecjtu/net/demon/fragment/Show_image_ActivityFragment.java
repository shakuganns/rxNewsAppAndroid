...
public class Show_image_ActivityFragment extends Fragment {
    ...
    private rxMutipleTouchViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentView = inflater.inflate(R.layout.fragment_show_image_, container, false);
        return mContentView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        options = new DisplayImageOptions.Builder()
                ...
                .cacheOnDisk(true)
                .build();
        viewPager = (rxMutipleTouchViewPager) mContentView.findViewById(R.id.tushuo_viewpager);
